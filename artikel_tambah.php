<?php
  ...
  if (isset($_POST['tambah'])) {
    ...
    mysqli_query($dbconnect,"INSERT INTO artikel VALUES('', '$gambar', '$judul', '$isi', '$tanggal', '$penulis', '$views')");
    ...
    <main class="main">
      <section class="article section mt-5" id="article">
        <div class="text-center">
          <h1 class="section__title">Tambah Artikel</h1>
        </div>
          ...
          <form method="POST" action="" class="contact_form" enctype="multipart/form-data">
            <div class="row">
              <div class="col-lg-6 col-sm-12">
                <div class="col contact__form-div">
                  ...
                  <input type="text" class="contact__form-input" name="judul" required>
                </div>
              </div>
              <div class="col-lg-6 col-sm-12">
                <div class="col contact__form-div">
                  <label for="" class="contact__form-tag">Gambar</label>
                  <input type="file" class="contact__form-input" name="gambar" required>
                </div>
              </div>
            </div>
            ...
            <div class="col contact__form-div">
              ...
              <?php
                $tanggal = date("Y/m/d");
              ?>
              <input type="text" class="contact__form-input" name="tanggal" value="<?= $tanggal; ?>" disabled>
            </div>

            <div class="col contact__form-div">
              <label for="" class="contact__form-tag">Penulis</label>
              <input type="text" class="contact__form-input" name="penulis" required>
            </div>

            <textarea class="contact__form-div" id="summernote" name="isi" required></textarea>

            
            <button class="button mt-5" name="tambah">Tambah artikel</button>
          </form>
        </div>
        <!-- End Project -->
      </section>
